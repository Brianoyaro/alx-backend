...
def get_timezone() -> Union[Any, str]:
    '''finds timezone of a user
    '''
    ...
    if timezone is None:
        ...
        # validate if timezone is valid timezone using pytz
    try:
...
def get_user() -> Union[None, object]:
    '''validates a user
    '''
...
def index() -> str:
    ...
    # time = format_datetime(datetime(1987, 3, 5, 17, 12))
